package com.fastcode.cloudsampleapp1.restcontrollers.core;
...
import com.fastcode.cloudsampleapp1.commons.search.SearchUtils;
import com.fastcode.cloudsampleapp1.application.core.filmcategory.FilmCategoryAppService;
import com.fastcode.cloudsampleapp1.application.core.filmcategory.dto.*;
import com.fastcode.cloudsampleapp1.domain.core.filmcategory.IFilmCategoryRepository;
import com.fastcode.cloudsampleapp1.domain.core.filmcategory.FilmCategoryEntity;
import com.fastcode.cloudsampleapp1.domain.core.category.ICategoryRepository;
import com.fastcode.cloudsampleapp1.domain.core.category.CategoryEntity;
import com.fastcode.cloudsampleapp1.domain.core.film.IFilmRepository;
import com.fastcode.cloudsampleapp1.domain.core.film.FilmEntity;
import com.fastcode.cloudsampleapp1.domain.core.rental.IRentalRepository;
import com.fastcode.cloudsampleapp1.domain.core.rental.RentalEntity;
import com.fastcode.cloudsampleapp1.domain.core.address.IAddressRepository;
import com.fastcode.cloudsampleapp1.domain.core.address.AddressEntity;
import com.fastcode.cloudsampleapp1.domain.core.language.ILanguageRepository;
import com.fastcode.cloudsampleapp1.domain.core.language.LanguageEntity;
import com.fastcode.cloudsampleapp1.domain.core.customer.ICustomerRepository;
import com.fastcode.cloudsampleapp1.domain.core.customer.CustomerEntity;
import com.fastcode.cloudsampleapp1.domain.core.staff.IStaffRepository;
import com.fastcode.cloudsampleapp1.domain.core.staff.StaffEntity;
import com.fastcode.cloudsampleapp1.domain.core.country.ICountryRepository;
import com.fastcode.cloudsampleapp1.domain.core.country.CountryEntity;
import com.fastcode.cloudsampleapp1.domain.core.city.ICityRepository;
import com.fastcode.cloudsampleapp1.domain.core.city.CityEntity;
import com.fastcode.cloudsampleapp1.domain.core.inventory.IInventoryRepository;
import com.fastcode.cloudsampleapp1.domain.core.inventory.InventoryEntity;
...
import com.fastcode.cloudsampleapp1.domain.core.filmcategory.FilmCategoryId;
